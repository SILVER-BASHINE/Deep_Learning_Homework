...
from features_d import color_histogram_hsv, hog_feature
from data_utils import *
def get_CIFAR10_data(num_training=49000, num_validation=1000, num_test=1000):
    # Load the raw CIFAR-10 data
    cifar10_dir = 'G:/warehouse/DL2019/hw2/hw2/working/datasets/cifar-10-batches-py'
...
from neural_net import ThreeLayerNet
...
for lr in lrs:
    for rg in rgs:
        for bt in batch_sizes:
            print("hid:%d,lr:%.4f,reg:%.4f,batch_size:%d"%(500,lr,rg,bt))
            status=net.train(X_train,y_train,y_val,y_val,num_iters=5000,batch_size=bt,
