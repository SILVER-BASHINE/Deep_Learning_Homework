...
if __name__ == "__main__":
    ...
    parser.add_argument('--content', type=str, default='G:/warehouse/DL2019/hw4/content.jpg')
    parser.add_argument('--style', type=str, default='G:/warehouse/DL2019/hw4/style.jpg')
